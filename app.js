...
// Complete the exercise in the space below:
totalYearsLived = inventors.reduce((total, currentInventor) => {
...
travelMethodCounts = travelMethods.reduce((agg, travelMethod) => {
  //   console.log(agg, travelMethod);
  if (travelMethod in agg) agg[travelMethod] += 1;
  else agg[travelMethod] = 1;
  return agg;
}, {});
